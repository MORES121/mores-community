...
class Policy:
    def __init__(self, model_dir: str = None):
        print("[MORES] v44 - Inline Quantization (Action Range ±1350V)")
        
        # PID 增益（介于 v42 和 v43 之间）
        self.kp_ip = 0.53
        self.kp_r = 1.48
        self.kp_z = 2.55
        
        # 动作限幅（介于 v42 和 v43 之间）
        self.action_low = -1350
        self.action_high = 1350
        ...
        print(f"[MORES] v44 Precomputed {len(self.action_table)} actions")
